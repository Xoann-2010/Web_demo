...
```
web_bac_si/
├── Mo_Phan_Mem.bat            # Tệp khởi chạy 1 chạm cho Bác sĩ (Tự động cài thư viện nếu thiếu & tự mở trình duyệt)
├── Cai_Dat_Moi_Truong.bat     # Tệp hỗ trợ cài đặt môi trường cho máy tính mới
